...
$l['redirect_return_forum'] = "<br /><br />Sinon, <a href=\"{1}\">retournez sur le forum</a>.";
$l['redirect_emailsent'] = "Votre message a été envoyé par email.";
$l['redirect_loggedin'] = "Vous êtes connecté.<br />Vous allez maintenant être dirigé vers la page d’où vous provenez.";

$l['error_invalidpworusername'] = "Vous avez entré une combinaison utilisateur/mot de passe invalide. <br /><br />Si vous avez oublié votre mot de passe veuillez en <a href=\"member.php?action=lostpw\">récupérer un nouveau</a>.";
$l['error_invalidpworusername1'] = "Vous avez entré une combinaison email/mot de passe invalide. <br /><br />Si vous avez oublié votre mot de passe veuillez en <a href=\"member.php?action=lostpw\">récupérer un nouveau</a>.";
$l['error_invalidpworusername2'] = "Vous avez entré une combinaison utilisateur/mot de passe ou email/mot de passe invalide. <br /><br />Si vous avez oublié votre mot de passe veuillez en <a href=\"member.php?action=lostpw\">récupérer un nouveau</a>.";
...
$l['error_alreadyuploaded'] = "Ce message contient déjà une pièce jointe de nom \"{1}\". Renommez le fichier et réuploadez-le. Sinon, vous pouvez cliquer sur \"Mettre à jour la pièce jointe\".";
$l['error_alreadyuploaded_perm'] = "Ce message contient déjà une pièce jointe de même nom. Supprimez le fichier existant ou renommez le fichier et uploadez-le à nouveau.";
...
$l['error_invalidthread'] = "Le sujet demandé n’existe pas.";
...
$l['error_closedinvalidforum'] = "Vous ne pouvez pas poster dans ce forum car il est fermé, ou c’est une redirecion sur une autre page web, ou c’est une catégorie.";
...
$l['error_attachsize'] = "Le fichier \"{1}\" est trop volumineux. Le poids maximal de ce type de fichier est de {1} kilo-octets.";
$l['error_uploadempty'] = "Le fichier \"{1}\" est vide.";
$l['error_uploadsize'] = "Le fichier à envoyer est trop volumineux.";
$l['error_uploadfailed'] = "L’envoi du fichier a échoué. Veuillez choisir un fichier valide et réessayer.";
...
$l['error_usernametaken'] = "Le nom d’utilisateur que vous avez choisi est déjà utilisé. Si vous êtes déjà enregistré sur ce forum, veuillez vous <a href=\"member.php?action=login\">connecter</a>.";
...
$l['forgot_password'] = "Perte du mot de passe ?";
...
$l['error_nopermission_user_2'] = "Votre compte a été suspendu ou vous avez été banni de l’accès à cette ressource.";
...
$l['please_correct_errors'] = "Corrigez les erreurs suivantes avant de continuer :";
$l['error_reachedattachquota'] = "Désolé, vous ne pouvez pas joindre ce fichier car vous avez atteint votre quota de {1}";
$l['error_maxattachpost'] = "Désolé, vous ne pouvez pas joindre ce fichier car vous avez atteint le nombre maximum de pièces jointes autorisées par mesaage qui est de {1}";
$l['error_invaliduser'] = "L’utilisateur demandé est invalide ou n’existe pas.";
$l['error_invalidaction'] = "Action invalide";
$l['error_messagelength'] = "Désolé, votre message est trop long et ne peut pas être posté. Essayez de le réduire et réessayez.";
...
$l['error_max_emails_day'] = "Vous ne pouvez pas utiliser les fonctionnalités ’Envoyer le sujet à un ami’ ou ’Envoyer un email à un utilisateur’ car vous avez déjà atteint votre quota alloué en envoyant {1} messages durant les dernières 24 heures.";
...
$l['emailsubject_forumsubscription'] = "Nouveau sujet sur {1}";
...
$l['emailsubject_reachedpmquota'] = "Quota de messagerie privée atteint sur {1}";
$l['emailsubject_changeemail'] = "Changement d’adresse email sur {1}";
$l['emailsubject_newpm'] = "Nouveau message privé sur {1} - {2}";
$l['emailsubject_newjoinrequest'] = "Nouvelle demande d’adhésion à {1}";
$l['emailsubject_sendtofriend'] = "Sujet intéressant sur {1}";
$l['emailsubject_changepassword'] = "Changement de mot de passe de {1}";
$l['emailbit_viewthread'] = "&hellip; (lisez le sujet pour en savoir plus&hellip;)";
...
Vous aurez besoin des informations suivantes :
Nom d’utilisateur : {1} (ou votre adresse email)
Code d’activation : {5}
...
La raison qu’a donnée l’utiliseur pour signaler cet utilisateur :
{6}
...
$l['email_reportreputation'] = "{1} de {2} a signalé la réputation suivante :

{3}
{4}/{5}

La raison qu’a donnée l’utiliseur pour signaler cette réputation:
{6}

Ce message a été envoyé à tous les modérateurs de ce forum, ou tous les administrateurs et super modérateurs s’il n’y a pas de modérateurs.

Veuillez vérifier cette réputation dès que possible.";
...
Vous aurez besoin de ce mot de passe pour vous identifier sur le forum. Une fois que vous serez connecté, vous pourrez le changer depuis le panneau de configuration utilisateur.
...
Il est recommandé de changer votre mot de passe immédiatement après votre connexion. Vous pourrez le faire en allant dans le panneau de configuration utilisateur, et en cliquant sur la modification de mot de passe dans le menu à gauche.
...
Nom d’utilisateur : {3} (ou votre adresse email)
Mot de passe : {4}
...
{2} a créé un nouveau sujet sur {3}. C’est le forum auquel vous vous êtes abonné sur {4}.
...
Pour voir le sujet, vous pouvez aller à cette adresse :
{7}/{8}

Il peut y avoir aussi d’autres nouveaux sujets et réponses, mais vous ne recevrez pas d’informations supplémentaires jusqu’à votre prochaine visite sur le forum.
...
Si vous ne voulez plus recevoir d’autres informations à propos des nouveaux sujets créés sur ce forum, visitez cette adresse :
...
Pour achever le processus d’activation sur {2}, vous devez aller sur l’adresse URL ci-dessous avec votre navigateur web.
...
{2} a répondu à un sujet auquel vous vous êtes abonné sur {3}. Ce sujet est intitulé {4}.
...
Si vous ne voulez plus recevoir d’autres informations à propos des nouvelles réponses créées sur le sujet auquel vous vous êtes abonné, visitez cette adresse :
...
Veuillez supprimer quelques messages de votre messagerie privée, et pensez à valider la suppression depuis la Corbeille.
...
Nous avons reçu une demande le {2} pour changer votre adresse email (voir détails ci-dessous).

Ancienne adresse email : {3}
Nouvelle adresse email : {4}

Ce changement a été automatiquement effectué. Si vous n’avez pas demandé ce changement, prenez contact avec un administrateur.
...
Vous recevez ce message parce que vous, ou quelqu’un ayant accès à votre mot de passe, a récemment changé le mot de passe de votre compte.

Nom d’utilisateur : {1}
Adresse email : {2}

Si vous n’avez pas demandé ce changement, prenez contact avec un administrateur.
...
------------------------------------------
 ...
 Pour voir, répondre ou transférer ce message, vous pouvez suivre ce lien :
...
Si vous ne voulez pas que les autres membres aient la possibilité de vous envoyer des emails veuillez vous rendre sur votre Panneau de configuration et activer l’option ’Cacher votre email aux autres membres’ :
{4}/usercp.php?action=options
...
{2} a demandé à adhérer à {3} le {4} (voir ci-dessous).

Raison: {5}

Pour accepter ou refuser cette demande, allez à
...
{2} vient de répondre à un sujet auquel vous êtes abonné. Ce sujet est intitulé {3}.
...
Pour voir le sujet, vous pouvez suivre l’url suivante :
[url]{5}/{6}[/url]

Il peut y avoir d’autres réponses à ce sujet mais vous ne recevrez plus de notifications jusqu’à ce que vous visitez le sujet à nouveau.

------------------------------------------
Information de désinscription :

Si vous ne voulez plus recevoir de notifications de réponses à ce sujet, suivez l’url suivante :
[url]{5}/usercp.php?action=removesubscription&tid={7}&my_post_key={8}[/url]

------------------------------------------";

$l['email_broken_task_subject'] = "Erreur de tâche MyBB le {1}";
$l['email_broken_task'] = "Votre copie de MyBB s’exécutant sur {1} ({2}) a rencontré une erreur du sytème de tâches.
