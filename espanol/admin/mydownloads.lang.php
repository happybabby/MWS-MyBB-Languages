...
/***************************************************************************
 *
 *   Mods &amp; Downloads plugin (/inc/languages/english/admin/mydownloads.php)
...
$l['mydownloads_add_download_banner_url'] = 'Banner URL';
$l['mydownloads_add_download_changelog'] = 'Changelog';
...
$l['mydownloads_add_download_download_preview'] = "Cover Image";
...
$l['mydownloads_add_download_short_description'] = 'Short Description';
$l['mydownloads_add_download_tags'] = 'Tags';
$l['mydownloads_add_download_tags_desc'] = 'Select the tags associated with this download.';
...
$l['mydownloads_approved'] = 'You have successfully accepted the selected file submission.';
$l['mydownloads_background_upload_error'] = 'An error occurred while trying to upload the Category Image.';
$l['mydownloads_background_upload_error2'] = 'A Category Image with the same name already exists.';
...
$l['mydownloads_category_deleteconfirm'] = "Are you sure you want to delete the Category \"{1}\"?";
$l['mydownloads_category_edited'] = "Category edited successfully.";
$l['mydownloads_close_window'] = 'Close Window';
$l['mydownloads_color'] = 'Color';
$l['mydownloads_color_desc'] = 'Enter the color like #HEXCOLOR (with #). You can also enter colors like red, green, blue.';
$l['mydownloads_create_category'] = "Create category";
$l['mydownloads_create_category_approval_only'] = "All file submissions need to be accepted";
$l['mydownloads_create_category_approval_only_desc'] = "Requires all file submissions to this category (excluding subcategories) to be accepted by staff before being available.";
$l['mydownloads_create_category_background'] = 'Category Image';
$l['mydownloads_create_category_background_desc'] = 'Select a Category Image to set for the category row (recommended height: 50px). When one is present, the category name is not displayed.';
...
$l['mydownloads_create_category_grid'] = "Grid View for Sub-Categories";
...
$l['mydownloads_de_suspend'] = 'Unsuspend';
...
$l['mydownloads_disapproved'] = 'You have successfully rejected the selected file submission.';
$l['mydownloads_disliked'] = 'disliked';
$l['mydownloads_disporder'] = "Disporder";
$l['mydownloads_down_deleteconfirm'] = "Are you sure you want to delete \"{1}\"?";
$l['mydownloads_down_resetconfirm'] = 'Are you sure you want to delete the images for the selected download?';
$l['mydownloads_down_resetfilesconfirm'] = 'Are you sure you want to delete the files for the selected download?';
$l['mydownloads_down_suspendconfirm'] = 'Are you sure you want to suspend "{1}"?<br/>If you chose to enter a message below, it will be sent to the submitter.';
$l['mydownloads_down_unsuspendconfirm'] = 'Are you sure you want to unsuspend "{1}"?<br/>If you chose to enter a message below, it will be sent to the submitter.';
...
$l['mydownloads_download_suspended'] = 'Download suspended successfully.';
$l['mydownloads_download_unsuspended'] = 'Download unsuspended successfully.';
$l['mydownloads_downloads'] = "Downloads";
$l['mydownloads_downloads_in_cat'] = "Downloads in category \"{1}\"";
$l['mydownloads_downloads_submissions']= 'File Submissions';
$l['mydownloads_edit'] = "Edit";
$l['mydownloads_edit_category'] = "Edit category";
$l['mydownloads_edit_category_approval_only'] = "All file submissions need to be accepted";
$l['mydownloads_edit_category_approval_only_desc'] = "Requires all file submissions to this category (excluding subcategories) to be accepted by staff before being available.";
$l['mydownloads_edit_category_background'] = 'Category Image';
$l['mydownloads_edit_category_background_desc'] = 'Select a Category Image to set for the category row (recommended height: 50px). When one is present, the category name is not displayed. Leaving empty will leave the current, if any.';
$l['mydownloads_edit_category_delete_background'] = 'Delete Category Image';
$l['mydownloads_edit_category_delete_background_desc'] = 'Tick this box to delete the current Category Image.';
...
$l['mydownloads_edit_category_grid'] = "Grid View for Sub-Categories";
...
$l['mydownloads_edit_download_banner_url'] = 'Banner URL';
$l['mydownloads_edit_download_category'] = "Category";
$l['mydownloads_edit_download_changelog'] = 'Changelog';
$l['mydownloads_edit_download_changelog'] = 'Changelog';
...
$l['mydownloads_edit_download_download_preview'] = "Cover Image";
$l['mydownloads_edit_download_download_preview_desc'] = "Cover Image to upload. (leave blank to use the current one)";
...
$l['mydownloads_edit_download_short_description'] = 'Short Description';
$l['mydownloads_edit_download_tags'] = 'Tags';
$l['mydownloads_edit_download_tags_desc'] = 'Select the tags associated with this download.';
...
$l['mydownloads_error_pm'] = 'An unknown error has occurrd while sending a Mods & Downloads adds a downloads system to MyBB. message.';
...
$l['mydownloads_global'] = 'Global';
$l['mydownloads_index'] = 'Mods & Downloads ({1})';
$l['mydownloads_invalid_report'] = 'Invalid reported download.';
$l['mydownloads_invalid_fid'] = 'You haven\'t selected a valid file.';
$l['mydownloads_invite_only'] = "Invite Only";
$l['mydownloads_liked'] = 'liked';
$l['mydownloads_log'] = "View log";
$l['mydownloads_log_action'] = "Action";
$l['mydownloads_log_file_approved'] = 'The file submission {2} submitted by {1} has been accepted.';
...
$l['mydownloads_log_file_disapproved'] = 'The file submission {2} submitted by {1} has been rejected.';
...
$l['mydownloads_log_download_rated'] = "User <a href=\"{1}/member.php?action=profile&uid={2}\">{3}</a> has {6} download <a href=\"{1}/mydownloads.php?action=view_down&did={4}\">{5}</a>";
...
$l['mydownloads_log_prune'] = 'Prune log entries';
$l['mydownloads_log_pruneconfirm'] =' Are you sure you want to prune log entries?';
$l['mydownloads_log_pruned'] = 'Log entries successfully pruned.';
$l['mydownloads_manage_submissions'] = 'Manage File Submissions';
$l['mydownloads_mark'] = 'Read';
$l['mydownloads_marked_downloads'] = 'Marked Downloads';
...
$l['mydownloads_no_tag'] = 'You must enter the tag name.';
$l['mydownloads_no_tags'] = 'No tags to display.';
$l['mydownloads_no_tid'] = 'You didn\'t select a valid tag.';
$l['mydownloads_no_version_set']= 'Version not set';
$l['mydownloads_num_downloads'] = "Number of downloads";
$l['mydownloads_older_than'] = 'Older than';
$l['mydownloads_older_than_desc'] = 'Prune log entries older than the number of days you enter.';
$l['mydownloads_or'] = "or";
...
$l['mydownloads_pm_message_file_approved'] = 'Hello, your file submission {1} has been accepted.';
$l['mydownloads_pm_message_file_disapproved'] = 'Hello, your file submission {1} has been rejected.';
$l['mydownloads_pm_subject_file_approved'] = 'Your file submission has been accepted';
$l['mydownloads_pm_subject_file_disapproved'] = 'Your file submission has been rejected.';
$l['mydownloads_previews_reset'] = 'Images have been deleted for the selected download.';
$l['mydownloads_files_reset'] = 'Files have been deleted for the selected download.';
$l['mydownloads_removed_rating'] = 'removed rating from';
...
$l['mydownloads_submission_dl_approve'] = 'Accept';
$l['mydownloads_submission_dl_approve_confirm'] = 'Are you sure you want to accept this submission?';
$l['mydownloads_submission_dl_banner'] = 'Banner';
$l['mydownloads_submission_dl_cat'] = 'Category';
$l['mydownloads_submission_dl_changelog'] = 'Changelog';
$l['mydownloads_submission_dl_desc'] = 'Description';
$l['mydownloads_submission_dl_disapprove'] = 'Reject';
$l['mydownloads_submission_dl_disapprove_confirm'] = 'Are you sure you want to reject this submission?';
...
$l['mydownloads_submission_dl_modify'] = 'Modify';
$l['mydownloads_submission_dl_name'] = 'Download Name';
$l['mydownloads_submission_dl_file'] = 'File';
$l['mydownloads_submission_dl_points'] = 'Points';
$l['mydownloads_submission_dl_preview'] = 'Cover Image';
$l['mydownloads_submission_dl_price'] = 'Price';
$l['mydownloads_submission_dl_short_desc'] = 'Short Description';
$l['mydownloads_submission_dl_version'] = 'Version';
$l['mydownloads_submission_dl_view'] = 'View';
$l['mydownloads_submission_dl_type'] = 'Type';
$l['mydownloads_submission_dl_size'] = 'Size';
...
$l['mydownloads_suspend_status'] = 'Suspend';
$l['mydownloads_suspend_status_pm_message'] = "Your download \"[url=https://modworkshop.net/mydownloads.php?action=view_down&did=1}]{2}[/url]\" has been suspended and is now only visible to you and the site staff.
It is no longer possible for users to download or view your download.
The status of your download is now locked and cannot be changed.
Your download is either suspended temporarily for investigation or permanently due to violating the  [url=https://modworkshop.net/showthread.php?tid=7826]rules[/url].
Should you wish to contact the staff or if your download has been updated to follow the rules you can send an \"Unsuspend Application\" [url=https://modworkshop.net/forumdisplay.php?fid=66]here[/url].

The site staff chose to attach the following message:

[quote]{3}[/quote]

Greetings,
Site Staff";
$l['mydownloads_suspend_status_pm_subject'] = "\"{1}\" was suspended.";
$l['mydownloads_suspended'] = "Suspended";
$l['mydownloads_suspended_downloads'] = 'Suspended Downloads';
$l['mydownloads_suspended_downloads_not_found'] = 'There are currently no suspended downloads.';
$l['mydownloads_tag'] = 'Tag';
$l['mydownloads_tag_added'] = 'Tag added successfully.';
$l['mydownloads_tag_deleteconfirm'] = 'Are you sure you want to delete the selected tag?';
$l['mydownloads_tag_deleted'] = 'Tag deleted successfully.';
$l['mydownloads_tag_edited'] = 'Tag edited successfully.';
$l['mydownloads_tags'] = 'Tags';
$l['mydownloads_tags_add'] = 'Add Tag';
$l['mydownloads_tags_add_description'] = 'Add a new tag.';
$l['mydownloads_tags_description'] = 'Manage the tags available for downloads.';
$l['mydownloads_tags_edit'] = 'Edit Tag';
$l['mydownloads_tags_edit_description'] = 'Edit an existing tag.';
$l['mydownloads_tags_global'] = 'Global';
$l['mydownloads_unlisted'] = "Unlisted";
$l['mydownloads_unmark'] = 'Unread';
$l['mydownloads_unsuspend_status_pm_message'] = "Your download \"[url=https://modworkshop.net/mydownloads.php?action=view_down&did={1}]{2}[/url]\" has been unsuspended. 
Users can now download or view your download again.
The status of your download is now unlocked and can be changed again.
...
Greetings,
Site Staff";
$l['mydownloads_unsuspend_status_pm_subject'] = "\"{1}\" was unsuspended.";
...
$l['mydownloads_upload_problem_pr_already_exists'] = "A Cover Image with the same name has already been uploaded";
$l['mydownloads_upload_problem_previewfile'] = "The following problem has occurred when uploading the Cover Image: ";
$l['mydownloads_username'] = 'Username';
...
$l['mydownloads_warn'] = 'Warn User';
$l['mydownloads_wrong_action_modname'] = "Wrong action or module name.";
$l['mydownloads_new_files'] = 'New Files';
$l['mydownloads_new_files_desc'] = 'New files are awaiting approval.';
$l['mydownloads_submission_image'] = 'Image';
$l['mydownloads_dl_awaiting_approval'] ='Download Awaiting Approval';
$l['mydownloads_cannot_change_hidden'] = 'The selected download status cannot be changed from hidden until there is at least one approved file associated with it.'; 
$l['mydownloads_public'] = "Public";
$l['mydownloads_hidden'] = 'Hidden';
$l['mydownloads_invite_only'] = "Invite Only";
$l['mydownloads_unlisted'] = "Unlisted";
$l['mydownloads_pm_status_changed_subject'] = 'Download Status Changed';
