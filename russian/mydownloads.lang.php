...
$l['mydownloads_delete_previews'] = 'Удалить изображения';
...
$l['mydownloads_in'] = 'в';
$l['mydownloads_invalid_banner'] = 'Недопустимый баннер. Допустимы только следующие форматы: bmp, gif, png, jpeg. If your file is jpg but not recognized then please convert to png.';
...
$l['mydownloads_latest_hot_submissions'] = 'Популярные новые материалы'; 
